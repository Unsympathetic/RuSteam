    ...
    public partial class CustomerModule : Form
    {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (check)
                {
                    if (MessageBox.Show("Вы точно хотите добавить этого клинета?", "Регистрация клиента", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
                    {
                        ...
                        cm.ExecuteNonQuery();
                        cn.Close();
                        MessageBox.Show("Клиент успешно добавлен!", title);
                        Clear();
        ...
        private void btnUpdate_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (check)
                {
                    if (MessageBox.Show("Вы точно хотите обновить этого клинета?", "обновление клиента", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
                    {
                        ...
                        cm.ExecuteNonQuery();
                        cn.Close();
                        MessageBox.Show("Клиент успешно обновлён!", title);
                        Clear();
                        customer.LoadCustomer();
                        this.Dispose();
                    }
